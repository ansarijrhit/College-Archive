...
testN:	.word 1			# Set this to 1 to test your program with N=1..5
test0:	.word 1			# Set this to 1 to test your program with N=0
...
p4:				# Program4 starts here.
	...
	beq	$t0, $0, done	# Jump to done if N is equal to 0
